...
public class ActorAddRatingFrag extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.content_actor_add_rating, container,false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ratingText = getView().findViewById(R.id.actorAddRatingText);
        ratingStars = getView().findViewById(R.id.actorAddRatingStars);
        save = getView().findViewById(R.id.actorAddRating);
    ...
    public void addRating(){
        ...
        String URL="https://umte-final.000webhostapp.com/addActorRating.php";
        StringRequest postRequest = new StringRequest(Request.Method.POST, URL,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(getContext(),"Chyba s připojením." ,Toast.LENGTH_LONG).show();
                    }
                }
        ) {
            @Override
