...
public class FilmAddRatingFrag extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.content_film_add_rating, container,false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ratingText = getView().findViewById(R.id.filmAddRatingText);
        ratingStars = getView().findViewById(R.id.filmAddRatingStars);
        save = getView().findViewById(R.id.filmAddRating);
    ...
    public void addRating(){
        ...
        String URL="https://umte-final.000webhostapp.com/addRating.php";
