...
import cz.uhk.umte.umte_final.DirectorDetailActivity;
import cz.uhk.umte.umte_final.Listeners.Top10DirectorsViewListener;
import cz.uhk.umte.umte_final.R;
import cz.uhk.umte.umte_final.adapter.Top10DirectorsFeedAdapter;
...
public class Top10DirectorsFrag extends Fragment implements Top10DirectorsViewListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.content_top10_directors, container,false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        //RECYCLERVIEW
        recyclerView = getView().findViewById(R.id.recyclerViewTop10Directors);
    ...
    private void renderView(List<Director> list){
        adapter = new Top10DirectorsFeedAdapter(list, this, value);
        recyclerView.setAdapter(adapter);
    }

    @Override
    public void onClicked(Director f) {
        Intent intent = new Intent(getActivity(), DirectorDetailActivity.class);
    ...
    public void loadData(){
        ...
        String URL="https://umte-final.000webhostapp.com/top10Directors.php";
