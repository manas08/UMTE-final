...
public class DirectorRatingFrag extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.content_director_ratings, container,false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        //RECYCLERVIEW
        recyclerView = getView().findViewById(R.id.recyclerViewRatingsDirector);
    ...
    public void loadData(){
        ...
        String URL="https://umte-final.000webhostapp.com/directorListRatings.php";
                            ...
                            try {
                                ...
                                for (int i = 0; i<1; i++){
                                    ...
                                    for (int j = 0 ; j<testArray.length();j++){
                                        ...
                                        directorid = testObject.getInt(1);
